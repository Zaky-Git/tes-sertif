...
export class ConfigurationComponent implements OnInit {
  ...
  scroll = (): void => {
    if (this.headerFixedLayout === false) {
      ...
      (
        document.querySelector(".nav.pcoded-inner-navbar") as HTMLElement
      ).classList.add("telu");
    }
  };
  ...
  constructor(private zone: NgZone, private location: Location) {
    ...
    this.setThemeLayout();
    this.layoutTypeStorage = localStorage.getItem("layoutType")
      ? localStorage.getItem("layoutType")
      : this.nextConfig.layoutType;
    this.headerBackColorStorage = localStorage.getItem("headerBackColor")
      ? localStorage.getItem("headerBackColor")
      : this.nextConfig.headerBackColor;
  }
  ...
  setLayout(layout) {
    ...
    if (layout === "menu-light" || layout === "reset") {
      ...
      this.setHeaderBackground("background-grd-telu");
      // this.setHeaderBackground("background-grd-telu");
